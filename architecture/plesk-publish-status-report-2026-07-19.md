...
> **Aktualizacja ścieżek 2026-07-22:** projekt został wydzielony do repozytorium
> `projekty/autonomicznosc-pl`; bieżące źródło publikacji znajduje się w
> `projekty/autonomicznosc-pl/02_landing`.
...
`workspace:autonomicznosc-pl` (`projekty/autonomicznosc-pl/02_landing`) i domeny
